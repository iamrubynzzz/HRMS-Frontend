...
const EmployeeSalary = () => {
  ...
  const fetchEmployeeSalaries = async () => {
    ...
    try {
      const response = await axios.get('/api/v1/salaries/my-salary', {
  ...
  // Fetch salaries on component mount and when filters change
  useEffect(() => {
    fetchEmployeeSalaries();
  ...
  return (
    <div className="salary-page">
      ...
      <div className="filters">
        ...
        <button onClick={fetchEmployeeSalaries}>Apply Filters</button>
      </div>
